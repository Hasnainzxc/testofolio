...
companies in bringing their ideas to life.
            ...
            <li>
            Continuously discovering, evaluating, and implementing the new technologies
to maximize development and writing efficiency.
            </li>
        ...
        <div className='py-6'>
          <p className='italic'>
            <span className='font-bold'>BACK-END ENGINEER</span>
            <span className='px-2'>|</span>Michigan, US
          </p>
          <p className='py-1 italic'>@DADS AGREE (FEB 2020 – dec 2020)</p>
          <ul className='list-disc list-outside px-7 py-1 leading-relaxed'>
            <li>
            Reduced average content deployment time by 20% through XML web form
reduction overhaul.
            </li>
            <li>
            Designed and Developed Front-end custom themes for E-commerce sites
utilizing HTML, CSS and Javascript.
            </li>
            <li>
            Worked with a team of 4 members to migrate four blogs from Wordpress to
Dads Agree, the company’s largest custom migration to date.
            </li>
