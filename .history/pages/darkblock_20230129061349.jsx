...
I have also contributed significantly to other parts of the project.   </p>
        ...
        <Link href='/#projects'>
  <button className='px-6 py-2 mt-4 text-white bg-indigo-500 hover:bg-indigo-600 rounded-lg border border-indigo-500 hover:border-indigo-600 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110'>
    Back
  </button>
</Link>
