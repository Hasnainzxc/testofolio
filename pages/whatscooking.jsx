    ...
    <div className='w-full'>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          Looking for recipe inspiration? Look no further. Welcome to WhatsCookin, Home to thousands of recipes from different cuisines and genres and which provides all the necessary instructions in a smart and concise way with a beautiful UI. Each recipe has a brief description, directions, a list of tips, difficulty level, Estimated cooking time, and nutritional information.</p>
